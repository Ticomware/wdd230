const apiURL = "http://api.openweathermap.org/data/2.5/weather?zip=83440,us&units=imperial&appid=6ab85a365f86c338d15b0ecfee11c84e";
fetch(apiURL)
  .then((response) => response.json())
  .then((jsObject) => {
    const iconURI = `http://openweathermap.org/img/wn/${jsObject["weather"][0].icon}@2x.png`;
